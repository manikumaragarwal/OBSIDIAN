...
The game uses a multi-screen approach: (total 3 screens)
	1. Setup Screen
	2. 

- **NOTE**: I am thinking of making it multiplayer.. but I don't know how to configure a firebase.. the backend handling is quite tough.. but the backend handling is quite tough.. but I'll figure it out somehow. hopefully.
...
1. **Text Gradients**: Used in headers for visual interest (in the \#setup-screen)
   ```css
   h1 {
...
- Uses DOM manipulation to build HTML.  
	- **NOTE**: I earlier tried to generate everything in the site itself, using DOM. That was fucking stupid.. so if You are ever in situation where you need to do generate something after an event.. the add a .hidden attribute.. and manipulate that. 
	- It's soo simple but I didn't think of it in the 1st version of this project. 
...
Hey, Thanks for reading all that bullshit!   hope you enjoy the game.

p.s.  don't try html injection. I've handled the edgecases, it's secure ;P
